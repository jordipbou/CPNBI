...
#define CPNBI_KEY_NUL       (CPNBI_KEY_BASE + 0)
#define CPNBI_KEY_BACKSPACE (CPNBI_KEY_BASE + 8)
#define CPNBI_KEY_TAB       (CPNBI_KEY_BASE + 9)
#define CPNBI_KEY_ENTER     (CPNBI_KEY_BASE + 13)
#define CPNBI_KEY_ESCAPE    (CPNBI_KEY_BASE + 27)
